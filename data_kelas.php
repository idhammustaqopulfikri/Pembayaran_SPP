...
if (isset($_POST['simpan'])) {
    ...
    $query = mysqli_query($conn, "INSERT INTO tb_kelas (id_kelas, nama_kelas, komp_keahlian) VALUES ('$id_kelas', '$nama_kelas', '$komp_keahlian')");
...
if (isset($_POST['update'])) {
    ...
    $query = mysqli_query($conn, "UPDATE tb_kelas SET nama_kelas='$nama_kelas', komp_keahlian='$komp_keahlian' WHERE id_kelas='$id_kelas'");
    header("Location: data_kelas.php");
}
                ...
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item active" href="data_kelas.php"><i class="bi bi-door-open"></i> Data Kelas</a></li>
    ...
    <div class="container mt-4">
        <div class="card">
            <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                <h5 class="mb-0"><i class="bi bi-door-open"></i> Data Kelas</h5>
                <button class="btn btn-light btn-sm" data-bs-toggle="modal" data-bs-target="#modalTambah"><i class="bi bi-plus"></i> Tambah Kelas</button>
            </div>
            <div class="card-body">
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo $row['komp_keahlian']; ?></td>
                                <td>
                                    <button class="btn btn-warning btn-sm" data-bs-toggle="modal" data-bs-target="#modalEdit<?php echo $row['id_kelas']; ?>"><i class="bi bi-pencil"></i></button>
                                    <a href="data_kelas.php?hapus=<?php echo $row['id_kelas']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Yakin ingin menghapus data ini?')"><i class="bi bi-trash"></i></a>
                                </td>
                            </tr>
                            <!-- Modal Edit -->
                                        ...
                                        <div class="modal-body">
                                            <form action="data_kelas.php" method="post">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="komp_keahlian" value="<?php echo $row['komp_keahlian']; ?>" required>
                                                </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="data_kelas.php" method="post">
                        ...
                        <div class="mb-3">
                            <label class="form-label">Kompetensi Keahlian</label>
                            <input type="text" class="form-control" name="komp_keahlian" required>
                        </div>
